...
const char  AutoConnectCore<T>::_PAGE_RESETTING[] PROGMEM = {
  "{{HEAD}}"
    "<meta http-equiv=\"refresh\" content=\"5;url={{BOOTURI}}\">"
  ...
  "<body>"
    ...
    "<script type=\"text/javascript\">"
      "window.onload=function(){"
        "var t=5,elm=document.getElementById(\"cd\"),ct=setInterval(function(){--t?elm.innerHTML=String(t)+\"&nbsp;sec.\":(elm.innerHTML=\"System Rebooted\",clearInterval(ct))},1e3);"
      "};"
    "</script>"
  "</body>"
  "</html>"
