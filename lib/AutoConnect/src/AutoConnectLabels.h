...
#define AUTOCONNECT_MENULABEL_CONFIGNEW   "Network"
...
#define AUTOCONNECT_MENULABEL_UPDATE      "Upgrade"
...
#define AUTOCONNECT_MENUCOLOR_ACTIVE      "#ffff00"
